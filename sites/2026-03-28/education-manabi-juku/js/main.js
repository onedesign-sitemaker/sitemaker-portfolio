...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (form) { form.addEventListener('submit', e => { e.preventDefault(); const btn = form.querySelector('button[type="submit"]'); btn.textContent = '申し込みを受け付けました！担当よりご連絡します。'; btn.disabled = true; }); }
});
